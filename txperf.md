...
Neither version gives much of a change.
	...
	$ curl  "http://10.64.222.170:9988/txPerf?n=10&d=30s" -X POST
	      n | Count | Commits | Aborts | Errors |        p25 |        p50 |        p90 |        p99 |
	 ------ | ----- | ------- | ------ | ------ | ---------- | ---------- | ---------- | ---------- |
	      0 |  5629 |    5629 |      0 |      0 | 4.659347ms | 5.102499ms | 6.546211ms | 9.041328ms |
	      1 |  5633 |    5633 |      0 |      0 | 4.642946ms | 5.090443ms |  6.49937ms |  8.94934ms |
	      2 |  5635 |    5635 |      0 |      0 | 4.645811ms | 5.099993ms | 6.512711ms | 8.904831ms |
	      3 |  5630 |    5630 |      0 |      0 | 4.649236ms | 5.100327ms | 6.498947ms | 8.967702ms |
	      4 |  5629 |    5629 |      0 |      0 | 4.647788ms | 5.104132ms | 6.499633ms | 9.165686ms |
	      5 |  5649 |    5649 |      0 |      0 | 4.643898ms | 5.094304ms | 6.470142ms | 8.748505ms |
	      6 |  5621 |    5621 |      0 |      0 |  4.65071ms | 5.114551ms | 6.548844ms | 9.025401ms |
	      7 |  5630 |    5630 |      0 |      0 | 4.651457ms | 5.102221ms | 6.512584ms | 8.924204ms |
	      8 |  5619 |    5619 |      0 |      0 | 4.659102ms | 5.106078ms | 6.561586ms | 8.988501ms |
	      9 |  5628 |    5628 |      0 |      0 | 4.648736ms | 5.109823ms | 6.569882ms | 8.887975ms |
	 ------ | ----- | ------- | ------ | ------ | ---------- | ---------- | ---------- | ---------- |
	 Totals | 56303 |   56303 |      0 |      0 | 4.649555ms | 5.102744ms | 6.521895ms | 8.958936ms |


	              Name |  Count |       Mean |        Min |        p50 |        p90 |        p99 |       p99.9 |         Max |
	 ----------------- | ------ | ---------- | ---------- | ---------- | ---------- | ---------- | ----------- | ----------- |
	  api.concat.check |  56303 | 0.980451ms | 0.391401ms | 0.846477ms | 1.530495ms | 3.288055ms |  4.269530ms |  4.280500ms |
	 api.concat.decide |  56303 | 1.694349ms | 0.774113ms | 1.597419ms | 2.134465ms | 3.473091ms | 22.181554ms | 22.223586ms |
	  api.concat.fetch |  56303 | 0.949524ms | 0.339084ms | 0.838113ms | 1.421904ms | 3.304763ms |  4.760648ms |  4.772741ms |
	  api.concat.write |  56303 | 1.674994ms | 0.844776ms | 1.591929ms | 2.170818ms | 3.429223ms |  5.078824ms |  5.083882ms |
	      client.check | 112606 | 0.747910ms | 0.284662ms | 0.614044ms | 1.186954ms | 2.747492ms |  4.930619ms |  4.973690ms |
	      client.fetch | 112606 | 0.706072ms | 0.260420ms | 0.580272ms | 1.167645ms | 2.193819ms |  5.013271ms |  5.066996ms |
	 client.sampleKeys |      1 | 2.855747ms | 2.855747ms | 2.855747ms | 2.855747ms | 2.855747ms |  2.855747ms |  2.855747ms |

	Partition Metrics: 0
	                      Name |   Count |       Mean |        Min |        p50 |        p90 |        p99 |      p99.9 |        Max |
	 ------------------------- | ------- | ---------- | ---------- | ---------- | ---------- | ---------- | ---------- | ---------- |
	      parition.apply.chunk | 1145058 | 0.023496ms | 0.000000ms | 0.011222ms | 0.050397ms | 0.113076ms | 2.746000ms | 2.822685ms |
	 partition.apply.lock.wait | 1145058 | 0.000812ms | 0.000000ms | 0.000606ms | 0.000687ms | 0.013239ms | 0.027132ms | 0.027142ms |
	     partition.check.check |   59211 | 0.048727ms | 0.002049ms | 0.004941ms | 0.034992ms | 0.796376ms | 9.790651ms | 9.984667ms |
	 partition.check.lock.wait |   59211 | 0.000877ms | 0.000000ms | 0.000607ms | 0.000665ms | 0.008464ms | 0.138295ms | 0.141902ms |

	Partition Metrics: 1
	                      Name |   Count |       Mean |        Min |        p50 |        p90 |        p99 |      p99.9 |        Max |
	 ------------------------- | ------- | ---------- | ---------- | ---------- | ---------- | ---------- | ---------- | ---------- |
	      parition.apply.chunk | 1146750 | 0.020255ms | 0.002404ms | 0.011270ms | 0.042926ms | 0.131971ms | 0.253604ms | 0.254855ms |
	 partition.apply.lock.wait | 1146750 | 0.000816ms | 0.000000ms | 0.000632ms | 0.000730ms | 0.010937ms | 0.026226ms | 0.026233ms |
	     partition.check.check |   59195 | 0.006363ms | 0.002605ms | 0.004760ms | 0.005979ms | 0.037254ms | 0.199215ms | 0.200906ms |
	 partition.check.lock.wait |   59195 | 0.000770ms | 0.000000ms | 0.000630ms | 0.000705ms | 0.001955ms | 0.040802ms | 0.041417ms |

	Partition Metrics: 2
	                      Name |   Count |       Mean |        Min |        p50 |        p90 |        p99 |      p99.9 |        Max |
	 ------------------------- | ------- | ---------- | ---------- | ---------- | ---------- | ---------- | ---------- | ---------- |
	      parition.apply.chunk | 1147154 | 0.021114ms | 0.000000ms | 0.011449ms | 0.051042ms | 0.134491ms | 0.218119ms | 0.218373ms |
	 partition.apply.lock.wait | 1147154 | 0.000912ms | 0.000000ms | 0.000639ms | 0.000746ms | 0.013360ms | 0.038227ms | 0.038414ms |
	     partition.check.check |   55720 | 0.011586ms | 0.003326ms | 0.004817ms | 0.005705ms | 0.035826ms | 4.019461ms | 4.096684ms |
	 partition.check.lock.wait |   55720 | 0.000798ms | 0.000000ms | 0.000632ms | 0.000689ms | 0.008032ms | 0.025065ms | 0.025178ms |

	Partition Metrics: 3
	                      Name |   Count |       Mean |        Min |        p50 |        p90 |        p99 |      p99.9 |        Max |
	 ------------------------- | ------- | ---------- | ---------- | ---------- | ---------- | ---------- | ---------- | ---------- |
	      parition.apply.chunk | 1147026 | 0.023503ms | 0.000000ms | 0.011933ms | 0.056435ms | 0.149969ms | 0.203359ms | 0.203712ms |
	 partition.apply.lock.wait | 1147026 | 0.000704ms | 0.000000ms | 0.000580ms | 0.000675ms | 0.004512ms | 0.021055ms | 0.021092ms |
	     partition.check.check |   55736 | 0.034068ms | 0.003010ms | 0.004697ms | 0.093787ms | 0.498398ms | 1.508684ms | 1.509010ms |
	 partition.check.lock.wait |   55736 | 0.000665ms | 0.000000ms | 0.000579ms | 0.000643ms | 0.001273ms | 0.017885ms | 0.017988ms |
